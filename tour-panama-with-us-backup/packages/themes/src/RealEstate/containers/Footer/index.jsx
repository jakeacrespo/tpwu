  ...
  <Box name={name} {...WrapperProps}>
    <Container {...ContainerProps}>
      ...
      <Box {...CopyrightWrapperProps}>
        <Typography {...CopyrightTextProps}>© {new Date().getFullYear()} {copyright}</Typography>

        <Box {...SocialLinksProps}>
          {socialLinks?.map((socialLink, key) => (
            <Fade left duration={600} key={socialLink.title} distance="10px" delay={100 * key}>
              <Button as="a" href={socialLink.href} title={socialLink.title} {...SocialLinkProps} target="_blank">
